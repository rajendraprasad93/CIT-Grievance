  ...
  return (
    <div className="min-h-screen bg-background pb-20 md:pb-0">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-heading font-bold mb-2" data-testid="report-issue-title">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            {similarIssues.length > 0 && (
              <div className="bg-amber-50 rounded-xl border border-amber-200 p-6" data-testid="similar-issues">
                  ...
                  {similarIssues.map((issue) => (
                    ...
                    >
                      <div className="flex items-start justify-between gap-2 mb-2">
                        ...
                        <span className={`px-2 py-1 rounded-full text-xs font-medium border whitespace-nowrap ${getStatusColor(issue.status)}`}>
                          {issue.status.replace('_', ' ').toUpperCase()}
                        </span>
                      </div>
                      <p className="text-xs text-muted-foreground mb-2">{issue.affected_count} affected</p>
                      <button
                        type="button"
